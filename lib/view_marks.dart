...
class view_marksub extends StatefulWidget {
  const view_marksub({Key? key}) : super(key: key);

  @override
  State<view_marksub> createState() => _State();
}

class _State extends State<view_marksub> {
                      ...
                      Row(
                        ...
                        children: [
                          _buildStatCard(
                            ...
                            label: "Average",
                            value: averageMark.toStringAsFixed(1),
                            color: _getScoreColor(averageMark.toString()),
                          ),
                          _buildStatCard(
                            icon: Icons.arrow_upward_rounded,
                            label: "Highest",
                            value: highestMark.toStringAsFixed(1),
                            color: _getScoreColor(highestMark.toString()),
                          ),
                          _buildStatCard(
                            icon: Icons.arrow_downward_rounded,
                            label: "Lowest",
                            value: lowestMark.toStringAsFixed(1),
                            color: _getScoreColor(lowestMark.toString()),
                          ),
                        ],
                      ),
                    ],
...
class Joke {
  ...
  Joke(this.id, this.question, this.answer, this.score);
}
