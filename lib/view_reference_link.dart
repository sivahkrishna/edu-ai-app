  ...
  Future<List<Joke>> _getJokes() async {
    ...
    try {
      var response = await http.post(
        Uri.parse("$ip/stud_view_reference"),
        body: {"unitid": prefs.getString("unitid")},
      );
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "Total Resources: ${snapshot.data.length}",
                          style: TextStyle(
                            color: _secondaryColor,
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Icon(Icons.calendar_today_rounded, size: 14, color: _whiteColor.withOpacity(0.9)),
                                          SizedBox(width: 4),
                                          Text(
                                            row.date,
                                            style: TextStyle(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _lightBgColor.withOpacity(0.5),
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: _accentColor,
                                      width: 1,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Icon(Icons.link_rounded, size: 16, color: _secondaryColor),
                                          ),
                                          SizedBox(width: 8),
                                          Text(
                                            "Reference Link",
                                      ...
                                      SizedBox(height: 8),
                                      GestureDetector(
                                        onTap: () => _copyToClipboard(row.refer_link, context),
                                        child: Container(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: ElevatedButton.icon(
                                          onPressed: () => _launchUrl(row.refer_link),
                                          icon: Icon(Icons.open_in_new_rounded, size: 18, color: _whiteColor),
                                          label: Text(
                                            'Open Link',
                                            style: TextStyle(
                                              fontSize: 14,
                                    ...
                                    Container(
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () => _copyToClipboard(row.refer_link, context),
                                        icon: Icon(Icons.content_copy_rounded, size: 18, color: _whiteColor),
                                        label: Text(
                                          'Copy',
                                          style: TextStyle(
                                            fontSize: 14,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _buildTipItem("Save important links for quick access"),
                            SizedBox(height: 8),
                            _buildTipItem("Make notes from each resource"),
                            SizedBox(height: 8),
                            _buildTipItem("Share useful materials with classmates"),
                            SizedBox(height: 8),
                            _buildTipItem("Review materials before exams"),
                          ],
                        ),
                      ),
                    ],
                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text(
                        "EDU AI Platform • Learning Materials",
                        style: TextStyle(
                          color: _secondaryColor,
                          fontSize: 13,
